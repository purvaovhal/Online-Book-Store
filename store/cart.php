...
<form action="cart.php" method="post">
  <table class="table" style="margin-top: 37px;">
    ...
    <tr>
      ...
      <td class="quantity"><input type="text" value="<?php echo $qty; ?>" size="2" name="<?php echo $isbn; ?>"></td>
  ...
  <input type="submit" class="btn changes" name="save_change" value="Save Changes">
</form>
<br/><br/>
